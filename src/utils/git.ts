...
export function parseRepositoryUrl(input: string): { url: string; name: string } {
  ...
  throw new Error('Invalid repository format. Use URL or GitHub shorthand (owner/repo)');
}
